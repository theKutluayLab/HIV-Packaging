...
print "Exon\t$exon\n";
print "CDS\t$CDS\n";
print "mRNA\t", $FiveUTR + $ThreeUTR + $CDS, "\n";
print "tRNA\t$tRNA\n";
print "7SL RNA\t$SevenSL\n";
print "rRNA\t$rRNA\n";
print "miRNA\t$miRNA\n";
print "lincRNA\t$lincRNA\n";
print "other_RNA\t", $exon - ($tRNA+$SevenSL+$miRNA+$rRNA+$CDS+$lincRNA),"\n";
print "Intron\t$intron\n";
...
print "Exon\t$rexon\n"; 
print "CDS\t$rCDS\n";
print "mRNA\t", $r5UTR + $r3UTR + $rCDS, "\n";
print "tRNA\t$rtRNA\n";
print "7SLRNA\t$r7SL\n";
print "rRNA\t$rrRNA\n";
print "miRNA\t$rmiRNA\n";
print "lincRNA\t$rlincRNA\n";
print "other_RNA\t", $rexon - ($rtRNA+$r7SL+$rmiRNA+$rrRNA+$rCDS+$rlincRNA),"\n";
